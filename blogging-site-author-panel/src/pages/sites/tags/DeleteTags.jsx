...
import { clearError, deleteTagsRequest, singleTagsRequest } from '../../../features/tagsSlice'
import { RiDeleteBinFill } from 'react-icons/ri'



export default function DeleteTags() {
  const { tagId, siteId } = useParams()
  const dispatch = useDispatch()
  const tag = useSelector(state => state.tags.singleTags)
        ...
        <div className="w-[30rem] min-h-80 bg-red-50 rounded-xl p-2 ">
          <div className=" rounded-xl h-full flex items-center justify-center flex-wrap py-auto overflow-hidden">
            ...
            <div className="basis-full text-xl  font-semibold">
              <p className="text-center h-fit text-gray-800">ARE YOU SURE TO DELETE Tag <br/>"{tag.tagName}"</p>
