...
export const blogAPI = {
    getAll: (siteId, page, limit) => {
        if (page && limit) {
            return axios.get(`${baseURL}/pages-by-site-id/${siteId}`, { params: { page, limit } }).then(res => res.data)
        }
        return axios.get(`${baseURL}/pages-by-site-id/${siteId}`).then(res => res.data)
    },
